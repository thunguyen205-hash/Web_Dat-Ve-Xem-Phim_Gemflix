...
**Máy chủ dữ liệu**: `http://gemflix.rf.gd/backend/api`
...
> **Lưu ý**: Website đã được kết nối với hệ thống máy chủ dữ liệu từ xa (`http://gemflix.rf.gd/backend/api`). Bạn không cần cài đặt cơ sở dữ liệu nội bộ trên máy tính của mình.
